"""
LEGACY ALEX LITTLE ONE PROTOCOL SOURCE.

This file is preserved for non-destructive history. PubCast core no longer
imports it. The active optional research implementation lives at
`modules/alex_little_one/care_profile.py` and is only loaded when
`ENABLE_ALEX_LITTLE_ONE=true`.
"""
